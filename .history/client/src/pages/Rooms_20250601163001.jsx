...
const RoomCard = ({ room }) => (
  ...
  ">
    ...
    <div className="p-4">
      ...
      <button className="bg-green-700 hover:bg-green-800 text-white py-1 px-4 ">
        Book Now
      </button>
    </div>
  </div>
...
const RoomSlider = () => {
  ...
  return (
    <div ref={ref} className={`fade-slide-up ${isVisible ? 'visible' : ''} py-10 bg-gray-100`}>
            ...
            <SwiperSlide key={index} className="w-[300px] sm:w-[340px]">
              <div className="bg-white shadow-md overflow-hidden w-[300px] sm:w-[340px]">
                ...
                <div className="p-4">
                  ...
                  <a >
                    <button href="#contact" className="bg-green-700 hover:bg-green-800 text-white py-1 px-4 ">
                    Book Now
                   </button>
                  </a>
