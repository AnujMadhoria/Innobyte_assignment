      ...
      >
        ...
        <div className="w-full md:w-1/2 space-y-6 animate-fade-in-up delay-200">
          ...
          <p className="text-gray-700 leading-relaxed word-reveal text-lg animate-fade-in-up delay-300">
            Nestled amidst nature’s finest, <span className="font-semibold reversing text-green-700">Kingsukh Guest House</span> offers an escape like no other — surrounded by the majestic Baranti, Susunia, and Biharinath hills.
