...
const RoomSlider = () => {
  ...
  return (
    <div id='' ref={ref} className={`fade-slide-up ${isVisible ? 'visible' : ''} py-10 bg-gray-100`}>
              ...
              <div className="bg-white shadow-md overflow-hidden w-[300px] sm:w-[340px]">
                ...
                <div className="p-4">
                  ...
                  <ul className="text-sm text-gray-600 mb-4 space-y-1">
                    ...
                    <a href='#contact'  className="bg-green-700 hover:bg-green-800 text-white py-1 px-4 ">
                    Book Now
                   </a>
                </div>
              </div>
