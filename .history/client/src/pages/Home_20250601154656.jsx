  ...
  return (
    ...
    >
      <div className="text-left text-white px-4">
        <h1 className="text-5xl md:text-7xl font-bold reversing fade-slide-up">
          Welcome to Kingsukh Guest House        .
        </h1>
        <p className="mt-4 text-lg md:text-xl tracking-widest font-medium  fade-slide-up delay-300  pb-9 pt-1">
